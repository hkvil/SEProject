                    ...
                    <tr class="item{{$trs->kode_transaksi}}">
                        ...
                        <td class="horizontal">
                            ...
                            <button data-urutan="{{$loop->iteration}}" data-id="{{$trs->kode_transaksi}}"
                                data-operator_nama="{{$trs->operator->nama}}" data-lapangan="{{$trs->kode_lapangan}}"
                                data-user="{{$trs->kode_user}}" data-user_nama="{{$trs->user->nama}}"
                                data-user_kontak="{{$trs->user->telepon}}" data-jadwal="{{$trs->kode_jadwal}}"
                                data-diskon="{{$trs->diskon}}" data-tanggal="{{$trs->tanggal}}"
                                class="btn btn-primary edit-modal">Ubah</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.item' + id).replaceWith("<tr class='item" + id + "'><th scope='row'>" +
                    ...
                    urutan + "' data-id='" + id + "' data-operator_nama='" + operatornama +
                    "' data-lapangan='" + lapangan + "' data-user='" + userid +
                    "' data-user_nama='" + usernama + "' data-user_kontak='" + userkontak +
                    "' data-jadwal='" + jadwal + "' data-diskon='" + diskon +
